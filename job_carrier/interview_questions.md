...
* Цель — интеграция данныз другого источника, если есть возможность к нему присоединиться (но сами запросы на чтения выполняются дольше, а INSERT, UPDATE, DELETE как правило недоступны).
